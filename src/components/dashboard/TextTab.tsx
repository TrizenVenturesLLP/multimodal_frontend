...
import { MessageSquare, CheckCircle, Info, Star, Shield, Zap, Target, Layout, BookOpen, Layers, Type, Heart, Activity } from "lucide-react";
...
const TextTab = ({ data }: TextTabProps) => {
