...
import AudioDatasetMetrics from "./AudioDatasetMetrics";
...
const VocalTab = ({ 
    ...
    const dominant = metrics?.dominant || "Neutral";
                            ...
                            <div className="bg-card rounded-3xl p-8 border shadow-sm flex-1">
                                ...
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center p-3 rounded-xl bg-secondary/30 border border-border/20">
                                        ...
                                        <span className="text-sm font-black text-primary">{dominant}</span>
                                    </div>
                                    <div className="flex justify-between items-center p-3 rounded-xl bg-secondary/30 border border-border/20">
